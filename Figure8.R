...
for(i in 1:18){
	...
	test = EnsembleMerge(data, methods = c("Seurat", "Harmony", "Liger", "BBKNN", "Scanorama"), normalization_method = "CLR", return = "Seurat", file = sprintf("Dataset_%i.csv", i))
...
write.csv(scores, file = "fig8.csv")