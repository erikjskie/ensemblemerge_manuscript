...
for(i in 1:18){
	...
	test = EnsembleMerge(data, methods = c("Seurat", "Harmony", "Liger", "BBKNN", "Scanorama", "fastMNN"), return = "Seurat", file = sprintf("Dataset_%i.csv", i))
...
write.csv(scores, file = "fig10.csv")